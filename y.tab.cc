...
{
       0,    53,    53,    56,    66,    70,    70,    82,    83,    87,
      92,    96,   102,   107,   111,   118,   119,   123,   126,   130,
     134,   135,   139,   140
};
#endif
...
#line 56 "shell.y"
    ...
    if(strcmp(Command::_currentSimpleCommand[0]->_arguments[0]->c_str(), "echo") == 0 && strchr((yyvsp[0].cpp_string), '?')) {
